...
<div class="<?php print $classes;?>">
  ...
  <?php else : ?>
    <h2><?php print t('There is no ') . '"'.$keys.'"' . t(' here,');?></h2>
    <h3><?php print t('but we think you would be more interested in what <strong>Paperwhite Studio</strong> can do for Google anyway.');?></h3>
